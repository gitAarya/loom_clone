    ...
    <main className='sign-in'>
        <aside className='testimonial'>
            ...
            <div className='description'> 
                <section>
                    <figure>
                        {Array.from({length:5}).map((_,index)=>(<Image src="/assets/icons/star.svg" alt='star' height={20} width={20} key={index}/>))}
                   
                    </figure>
                    <p>
                        SnapCast makes screen recording easy . From quick walkthrough to full presentation ,Its fast ,smooth and shareable in seconds
                    </p>
                    <article>
